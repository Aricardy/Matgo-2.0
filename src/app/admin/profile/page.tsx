        ...
        if (storedUser) {
            try {
                ...
                if (response.ok) {
                    ...
                    setUser({
                        firstName: profile.firstName || profile.name?.split(' ')[0] || 'Admin',
                        lastName: profile.lastName || profile.name?.split(' ')[1] || 'User',
                        email: profile.email || 'admin@matgo.com',
                    ...
                    setUser({
                        ...
                        email: userData.email || 'admin@matgo.com',
  ...
  const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/users/profile`, {
        ...
        if (response.ok) {
            ...
            if (storedUser) {
                ...
                localStorage.setItem('matgoUser', JSON.stringify(updatedUserData));
            }
